...
function abrirMenu() {
  document.querySelector('.menu-mobile').classList.add('ativo');
  document.querySelector('.btn-abrir-menu').classList.add('ativo');
}

function fecharMenu() {
  document.querySelector('.menu-mobile').classList.remove('ativo');
  document.querySelector('.btn-abrir-menu').classList.remove('ativo');
}
